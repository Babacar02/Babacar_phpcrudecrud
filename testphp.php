...
<p> Prints out a persons first,last name and hiring date if their first name is Marc</p>
<?php

//this is the php object oriented style of creating a mysql connection
$conn = new mysqli('localhost', 'Babacar', 'Soccer', 'employees' );
...
$sql = "SELECT first_name,last_name,hire_date FROM employees where first_name = 'Marc'";
